  ...
  events: [
    {
      ...
      allDay: true,
      description:
        'لورم ایپسوم به سادگی متن ساختگی در صنعت چاپ و حروفچینی است. از دهه 1500 لورم ایپسوم متن ساختگی استاندارد صنعت بوده است.',
      venue: 'City Town',
    ...
    },
    {
      ...
      allDay: true,
      description:
        'نه تنها از پنج قرن، بلکه از جهش به حروفچینی الکترونیکی نیز جان سالم به در برده است که اساساً بدون تغییر باقی مانده است.',
      venue: 'City Town',
...
if (pc_event_remove) {
  pc_event_remove.addEventListener('click', function () {
    ...
    swalWithBootstrapButtons
      .fire({
        title: 'مطمئنی؟',
        text: 'می خواهید این رویداد را حذف کنید؟',
        icon: 'warning',
  ...
  pc_event_add.addEventListener('click', function () {
    ...
    if (pc_event_add.getAttribute('data-pc-action') == 'add') {
      ...
      Swal.fire({
        ...
        icon: 'success',
        title: 'موفق',
        text: 'رویداد با موفقیت به روز شد'
      });
    }

...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('#btn-default').addEventListener('click', function () {
    notifier.show('سلام!', 'من یک اعلان پیش فرض هستم.', '', '', 0);
  });

  document.querySelector('#btn-info').addEventListener('click', function () {
    notifier.show('یادآوری', 'You have a meeting at 10:30 AM.', 'info', '', 0);
  });

  document.querySelector('#btn-success').addEventListener('click', function () {
    notifier.show('آفرین!', 'You just submit your resume successfully.', 'success', '', 0);
  });

  document.querySelector('#btn-warning').addEventListener('click', function () {
    notifier.show('هشدار!', 'The data presented here can be change.', 'warning', '', 0);
  });

  document.querySelector('#btn-danger').addEventListener('click', function () {
    notifier.show('متاسفم!', 'Could not complete your transaction.', 'danger', '', 0);
  });

  document.querySelector('#btn-default-i').addEventListener('click', function () {
    notifier.show('پیش فرض!', 'من یک اعلان پیش فرض هستم.', '', '../assets/images/notification/clock-48.png', 0);
  });

  document.querySelector('#btn-info-i').addEventListener('click', function () {
    notifier.show('یادآوری!', 'You have a meeting at 10:30 AM.', 'info', '../assets/images/notification/survey-48.png', 0);
  });

  document.querySelector('#btn-success-i').addEventListener('click', function () {
    notifier.show('آفرین!', 'You just submit your resume successfully.', 'success', '../assets/images/notification/ok-48.png', 0);
  });
  ...
  document.querySelector('#btn-default-ac').addEventListener('click', function () {
    notifier.show('Default!', 'من یک اعلان پیش فرض هستم.', '', '../assets/images/notification/clock-48.png', 4000);
  });

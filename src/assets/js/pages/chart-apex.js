...
setTimeout(function () {
  (function () {
    var options = {
      ...
      xaxis: {
        categories: ['فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'ابان', 'آذر']
      }
    };
    ...
    var options_different = {
      ...
      xaxis: {
        categories: ['01 مهر', '02 مهر', '03 مهر', '04 مهر', '05 مهر', '06 مهر', '07 مهر', '08 مهر', '09 مهر', '10 مهر', '11 مهر', '12 مهر']
      },
      tooltip: {
        y: [
          {
    ...
    document.querySelector('#one_month').addEventListener('click', function (e) {
      ...
      chart.updateOptions({
        xaxis: {
          min: new Date('28 مهر 2013').getTime(),
    ...
    document.querySelector('#ytd').addEventListener('click', function (e) {
      ...
      chart.updateOptions({
        xaxis: {
          min: new Date('01 مهر 2013').getTime(),
          max: new Date('27 Feb 2013').getTime()
        }
      });
    });
    ...
    var options_bar_chart_1 = {
      ...
      xaxis: {
        categories: ['فروردین', 'اردیبهشت', 'خرداد', 'مهر', 'ابان', 'آذر', 'بهمن']
      },
      fill: {
        opacity: 1
      },

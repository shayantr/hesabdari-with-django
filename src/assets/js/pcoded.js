...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', window.STATIC_URL + 'images/logo-white.svg');
}
...
function layout_sidebar_change(value) {
  if (value == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', window.STATIC_URL + 'images/logo-white.svg');
    }
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', window.STATIC_URL + 'images/logo-dark.svg');
    }
    var control = document.querySelector('.theme-sidebar-color .btn.active');
    if (control) {
      document.querySelector('.theme-sidebar-color .btn.active').classList.remove('active');
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', window.STATIC_URL + 'images/logo-white.svg');
    }
    ...
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', window.STATIC_URL + 'images/logo-white.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', window.STATIC_URL + 'images/logo-white.svg');
    }
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', window.STATIC_URL + 'images/logo-dark.svg');
    }
    ...
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', window.STATIC_URL + 'images/logo-dark.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', window.STATIC_URL + 'images/logo-dark.svg');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
